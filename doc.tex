...
\begin{center}
\includegraphics[width=0.70\textwidth]{flowchart.jpeg}
\end{center}
\subsection{Paterson Stockmeyer Algorithm}
...
Wikipedia: 
\bibitem{lamport94}
Padraic Bartlett: Math108B, L5, The Schur Decomposition
\bibitem{amit}
Amit Waisel: Parallel Algorithms for Evaluating Matrix Polynomials
