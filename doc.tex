...
\begin{figure}
    \centering
    \includegraphics[width={schur.png}
    \caption{Order of Execution of schur decomposition}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{patersonStockmeyer.jpeg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{parlett.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{sylvester.png}
